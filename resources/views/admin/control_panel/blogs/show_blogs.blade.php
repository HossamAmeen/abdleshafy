                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="panel-title">المقالات</span>
                                <a href="{{url('admin/blog/create')}}">  <button class="alert-success"> <i class="fa fa-plus"></i> </button> </a>
                                ...
                                <div class="ls-editable-table table-responsive ls-table">
                                    <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                        ...
                                        @foreach ($blogs as $blog)
                                            ...
                                            @endif
                                                <td >
                                                    <a href="{{url('/admin/blog/'.$blog->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                                    <a href="{{url('/admin/blog/delete/'.$blog->id)}}" class="btn btn-danger check">حذف</a>
