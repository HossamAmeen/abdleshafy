                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="panel-title">الاخبار</span>
                                    ...
                                    <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                                        ...
                                        @foreach ($newss as $news)
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo substr($news->description , 0 , 150)  ?></td>
                                                @if($news->user != null)
                                            ...
                                            @endif
                                                <td >
                                                    <a href="{{url('/admin/news/'.$news->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                                    <a href="{{url('/admin/news/delete/'.$news->id)}}" class="btn btn-danger check">حذف</a>
                    ...
                    <div class="nano-content">
                        <div class="chat-group chat-group-fav">
                            ...
                            <a href="javascript:void(0)">
                                <span class="news-status is-online"></span>
                                Catherine J. Watkins
                                <span class="badge badge-lightBlue">1</span>
                            </a>
                            <a href="javascript:void(0)">
                                <span class="news-status is-idle"></span>
                                Fernando G. Olson
                            </a>
                            <a href="javascript:void(0)">
                                <span class="news-status is-busy"></span>
                                Susan J. Best
                            </a>
                            <a href="javascript:void(0)">
                                <span class="news-status is-offline"></span>
                                Brandon S. Young
                            </a>
                        </div>
                    ...
                    <div class="chat-box-content">
                        <div class="nano nano-chat">
                            <div class="nano-content">
                                ...
                                <ul>
                                    <li>
                                        <span class="news">Catherine</span>
                                        <p>Are you here?</p>
