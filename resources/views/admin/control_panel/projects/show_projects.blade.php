                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="panel-title">المشروعات</span>
                                <a href="{{url('admin/project/create')}}">  <button class="alert-success"> <i class="fa fa-plus"></i> </button> </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('/admin/project/'.$project->id.'/edit')}}"
                                                       ...
                                                       aria-pressed="true">{{$project->ar_title}} </a>
                                                </td>
                                                <td><?php echo substr($project->description ,0 , 150)  ?></td>
                                                ...
                                                @endif
                                                <td >
                                                    <a href="{{url('/admin/project/'.$project->id.'/edit')}}" class="btn btn-info">تحديث</a>
                                                    <a href="{{url('/admin/project/delete/'.$project->id)}}" class="btn btn-danger check">حذف</a>
                    ...
                    <div class="nano-content">
                        <div class="chat-group chat-group-fav">
                            ...
                            <a href="javascript:void(0)">
                                <span class="blog-status is-online"></span>
                                Catherine J. Watkins
                                <span class="badge badge-lightBlue">1</span>
                            </a>
                            <a href="javascript:void(0)">
                                <span class="blog-status is-idle"></span>
                                Fernando G. Olson
                            </a>
                            <a href="javascript:void(0)">
                                <span class="blog-status is-busy"></span>
                                Susan J. Best
                            </a>
                            <a href="javascript:void(0)">
                                <span class="blog-status is-offline"></span>
                                Brandon S. Young
                            </a>
                        </div>
                    ...
                    <div class="chat-box-content">
                        <div class="nano nano-chat">
                            <div class="nano-content">
                                ...
                                <ul>
                                    <li>
                                        <span class="blog">Catherine</span>
                                        <p>Are you here?</p>
