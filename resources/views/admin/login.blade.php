...
<head>
    ...
    <!-- Plugin Css End -->
    <!-- Custom styles Style -->
    <link href="{{ asset('resources/assets/admin//css/style.css')}}" rel="stylesheet">
    <!-- Custom styles Style End-->

    <!-- Responsive Style For-->
    <link href="{{ asset('resources/assets/admin//css/responsive.css')}}" rel="stylesheet">
    <!-- Responsive Style For-->
